...
public class ReclutadorServiceImpl implements ReclutadorService {
    ...
    public ReclutadorDetalleDTO obtenerDetalleReclutador(Long reclutadorId, Long empresaIdLogueada) {
        ...
        // 3. Mapear a DTO
        List<EmpleadoResumenDTO> evaluadoresAsociados = relaciones.stream()
    ...
    // --- Helper de Mapeo --- //
    private EmpleadoResumenDTO mapearAEvaluadorResumenDTO(ReclutadorEvaluador relacion) {
        EmpleadoResumenDTO dto = new EmpleadoResumenDTO();
        
        dto.setEmpleadoId(relacion.getEvaluador().getId()); 
	...
	@Override
    @Transactional
    @RegistroBitacoraAnnotation(accion = AccionBitacoraEnum.REASIGNAR_CARGA_RECLUTADOR, descripcion = "Se reasigno la carga de un reclutador")
