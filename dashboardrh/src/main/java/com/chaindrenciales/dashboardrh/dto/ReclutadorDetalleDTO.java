...
public class ReclutadorDetalleDTO {
	...
	private List<EmpleadoResumenDTO> evaluadores;
	...
	public List<EmpleadoResumenDTO> getEvaluadores() {
		return evaluadores;
	}

	public void setEvaluadores(List<EmpleadoResumenDTO> evaluadores) {
